...
public class AdminExComplain extends PageUtils{
	...
	private void initialize() {
		...
		aec.getContentPane().add(calErrorText);
		...
		aec.getContentPane().add(deleteBtn);
		...
		aec.getContentPane().add(clearBtn);
		...
		aec.getContentPane().add(addUserBtn);
		...
		aec.getContentPane().add(backBtn);
